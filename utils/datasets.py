...
class NYUDepthDataset(Dataset):
    def __init__(self, args, idx):
        ...
        _h5py = h5py.File('data/nyu_depth/nyu_depth_v2_labeled.mat', 'r')
...
class NYUDepthDataModule(pl.LightningDataModule):
    ...
    def setup(self, stage=None):
        ...
        self.train_loader = NYUDepthDataset(self.args, train_idx)
        self.val_loader = NYUDepthDataset(self.args, test_idx)
...
class Make3DDataset(Dataset):
    def __init__(self, depth_paths, image_paths, args):
        self.args = args
    ...
    def __getitem__(self, index):
        ...
        depth = cv2.resize(depth, (480, 320), interpolation=cv2.INTER_LINEAR)
        image = cv2.resize(image, (480, 320), interpolation=cv2.INTER_LINEAR)
...
class Make3DDataModule(pl.LightningDataModule):
    ...
    def setup(self, stage=None):
        self.train_dataset = Make3DDataset("data/make3d/Train400Depth", "data/make3d/Train400Img", self.args)
        self.val_dataset = Make3DDataset("data/make3d/Test134Depth", "data/make3d/Test134Img", self.args)
